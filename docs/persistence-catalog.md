...
Sources: [`packages/core/session/src/types.ts:368`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:485`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:514`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:546`](../packages/core/session/src/types.ts)
...
#### `session/history-insert` — log-only
