...
来源：[`packages/core/session/src/types.ts:368`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:485`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:514`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:546`](../packages/core/session/src/types.ts)
...
<a id="sessionhistory-insert--log-only"></a>

#### `session/history-insert` — 仅日志
