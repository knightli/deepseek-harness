...
export const zh = {
  ...
  'catalog.loading': '正在加载会话…',
  'catalog.error': '会话加载失败',
  'catalog.retry': '重试',
  'catalog.refreshing': '正在刷新会话…',
  'catalog.stale': '会话刷新失败，正在显示上次结果。',
  ...
  'menu.fork': '分叉会话',
  'fork.error': '无法分叉此会话。',
  'fork.partial': '会话已分叉，但未能完成子会话设置。',
  'fork.unknown': '分叉结果未知。请刷新会话列表后再决定是否重试。',
...
export const en = {
  ...
  'catalog.loading': 'Loading sessions…',
  'catalog.error': 'Couldn’t load sessions',
  'catalog.retry': 'Retry',
  'catalog.refreshing': 'Refreshing sessions…',
  'catalog.stale': 'Session refresh failed. Showing the last result.',
  ...
  'fork.error': 'Couldn’t fork this session.',
  'fork.partial': 'Session forked, but child setup couldn’t be completed.',
  'fork.unknown': 'Fork result is unknown. Refresh the session list before retrying.',
